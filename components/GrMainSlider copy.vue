    ...
    <div class="gr-main-slider__list">
      <div class="gr-main-slider__slide">
        <img
          ...
          :src="getImageUrl(activeSlide.img)"
        />
        <div v-if="activeSlide.text1" class="gr-main-slider__text">
          <p>{{ activeSlide.text1 }}</p>
          <span>{{ activeSlide.text2 }}</span>
        </div>
      </div>
    </div>
...
export default {
  data() {
    return {
      ...
      slides: [
        {
          img: 'gr-main-slider/gromovo_08.jpg',
          text1: 'Громово парк',
          text2: 'Комфортабельные коттеджи в уголке Карельского перешейка',
        },
        {
          img: 'gr-main-slider/gromovo_03.jpg',
        },
        {
          img: 'gr-main-slider/gromovo_04.jpg',
          text1: 'Громово парк',
          text2: 'Комфортабельные коттеджи в уголке Карельского перешейка',
        },
        {
          img: 'gr-main-slider/gromovo_05.jpg',
        },
        {
          img: 'gr-main-slider/gromovo_07.jpg',
        },
      ],
      slide: {},
    };
  ...
  computed: {
    activeSlide() {
      return (this.slide = this.slides[this.currentActive]);
    },
    dotsCount() {
